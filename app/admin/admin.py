...
from .models import subscriber, comment, article,event,song,artist #, services, groups, permitted_svc, svc_instances
...
register_crud(admin, '/articles', 'article', article, filters=news_filters)
register_crud(admin, '/events', 'event', event, filters=[])
register_crud(admin, '/subscribers', 'subscriber', subscriber)
register_crud(admin, '/comments', 'comment', comment, filters=comment_filters)
register_crud(admin, '/songs', 'song', song)
register_crud(admin, '/artists', 'artist', artist)
